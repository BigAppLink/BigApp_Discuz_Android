 ...
 */
package com.youzu.android.framework.json.util;
...
import com.youzu.android.framework.json.annotation.JSONType;
...
public class TypeUtils {
    ...
    public static final Date castToDate(Object value) {
        ...
        if (value instanceof String) {
            ...
            if (strVal.indexOf('-') != -1) {
                String format;
                if (strVal.length() == JsonUtils.DEFFAULT_DATE_FORMAT.length()) {
                    format = JsonUtils.DEFFAULT_DATE_FORMAT;
