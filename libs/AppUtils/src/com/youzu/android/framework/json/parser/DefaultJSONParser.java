...
import static com.youzu.android.framework.json.parser.JSONScanner.EOI;
import static com.youzu.android.framework.json.parser.JSONToken.EOF;
import static com.youzu.android.framework.json.parser.JSONToken.ERROR;
import static com.youzu.android.framework.json.parser.JSONToken.FALSE;
import static com.youzu.android.framework.json.parser.JSONToken.LBRACE;
import static com.youzu.android.framework.json.parser.JSONToken.LBRACKET;
import static com.youzu.android.framework.json.parser.JSONToken.LITERAL_FLOAT;
import static com.youzu.android.framework.json.parser.JSONToken.LITERAL_INT;
import static com.youzu.android.framework.json.parser.JSONToken.LITERAL_STRING;
import static com.youzu.android.framework.json.parser.JSONToken.NEW;
import static com.youzu.android.framework.json.parser.JSONToken.NULL;
import static com.youzu.android.framework.json.parser.JSONToken.RBRACKET;
import static com.youzu.android.framework.json.parser.JSONToken.SET;
import static com.youzu.android.framework.json.parser.JSONToken.TREE_SET;
import static com.youzu.android.framework.json.parser.JSONToken.TRUE;
...
import com.youzu.android.framework.json.parser.deserializer.ListResolveFieldDeserializer;
import com.youzu.android.framework.json.parser.deserializer.MapResolveFieldDeserializer;
...
public class DefaultJSONParser extends AbstractJSONParser {
    ...
    private String                     dateFormatPattern = JsonUtils.DEFFAULT_DATE_FORMAT;
    ...
    public DefaultJSONParser(String input){
        this(input, ParserConfig.getGlobalInstance(), JsonUtils.DEFAULT_PARSER_FEATURE);
    }

    public DefaultJSONParser(final String input, final ParserConfig config){
        this(input, new JSONScanner(input, JsonUtils.DEFAULT_PARSER_FEATURE), config);
    }
