...
import com.youzu.android.framework.http.client.entity.BodyParamsEntity;
import com.youzu.android.framework.http.client.multipart.HttpMultipartMode;
import com.youzu.android.framework.http.client.multipart.MultipartEntity;
import com.youzu.android.framework.http.client.multipart.content.ContentBody;
import com.youzu.android.framework.http.client.multipart.content.FileBody;
import com.youzu.android.framework.http.client.multipart.content.InputStreamBody;
import com.youzu.android.framework.http.client.multipart.content.StringBody;
...
public class RequestParams {
    ...
    public void removeAllQueryStringParameter() {
        if (queryStringParams == null) {
            queryStringParams = new ArrayList<NameValuePair>();
        } else
    ...
    public void removeAllBodyParameter() {
        if (bodyParams == null) {
            bodyParams = new ArrayList<NameValuePair>();
        } else
            bodyParams.clear();
    ...
    public String toString(String prefix) {
        ...
        if (bodyParams != null) {
            sb.append(" ###post start### ");

            for (int i = 0; i < bodyParams.size(); i++) {
                sb.append((i == 0) ? prefix : "&");
                pair = bodyParams.get(i);
