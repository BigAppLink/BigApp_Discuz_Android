...
public class TableUtils {
     ...
     * key: entityType.name
     */
    private static ConcurrentHashMap<String, com.youzu.android.framework.db.table.Id> entityIdMap = new ConcurrentHashMap<String, com.youzu.android.framework.db.table.Id>();

    /* package */
    static synchronized com.youzu.android.framework.db.table.Id getId(Class<?> entityType) {
        ...
        com.youzu.android.framework.db.table.Id id = new com.youzu.android.framework.db.table.Id(entityType, primaryKeyField);
        entityIdMap.put(entityType.getName(), id);
        return id;
    }

    private static String getPrimaryKeyFieldName(Class<?> entityType) {
        com.youzu.android.framework.db.table.Id id = getId(entityType);
