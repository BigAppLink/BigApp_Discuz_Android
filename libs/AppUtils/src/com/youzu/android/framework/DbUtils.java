...
import com.youzu.android.framework.db.sqlite.*;
import com.youzu.android.framework.db.table.DbModel;
import com.youzu.android.framework.db.table.Id;
import com.youzu.android.framework.db.table.Table;
import com.youzu.android.framework.db.table.TableUtils;
...
public class DbUtils {
    ...
    public synchronized void saveOrUpdate(Object entity) throws DbException {
        try {
            beginTransaction();
    ...
    public synchronized void saveOrUpdateAll(List<?> entities) throws DbException {
    ...
    public synchronized void replace(Object entity) throws DbException {
        try {
            beginTransaction();
    ...
    public synchronized void replaceAll(List<?> entities) throws DbException {
        if (entities == null || entities.size() == 0) return;
        try {
            beginTransaction();
    ...
    public synchronized void saveAll(List<?> entities) throws DbException {
        if (entities == null || entities.size() == 0) return;
        try {
            beginTransaction();
    ...
    public synchronized void saveBindingIdAll(List<?> entities) throws DbException {
        if (entities == null || entities.size() == 0) return;
        try {
            beginTransaction();
    ...
    public synchronized void deleteById(Class<?> entityType, Object idValue) throws DbException {
    ...
    public synchronized void delete(Object entity) throws DbException {
    ...
    public synchronized void delete(Class<?> entityType, WhereBuilder whereBuilder) throws DbException {
        if (!tableIsExist(entityType)) return;
        try {
            beginTransaction();
    ...
    public synchronized void deleteAll(List<?> entities) throws DbException {
    ...
    public synchronized void deleteAll(Class<?> entityType) throws DbException {
    ...
    public synchronized void update(Object entity, WhereBuilder whereBuilder, String... updateColumnNames) throws DbException {
        if (!tableIsExist(entity.getClass())) return;
        try {
            beginTransaction();
    ...
    public synchronized void updateAll(List<?> entities, String... updateColumnNames) throws DbException {
        if (entities == null || entities.size() == 0 || !tableIsExist(entities.get(0).getClass())) return;
        try {
            beginTransaction();
    ...
    public synchronized void updateAll(List<?> entities, WhereBuilder whereBuilder, String... updateColumnNames) throws DbException {
        if (entities == null || entities.size() == 0 || !tableIsExist(entities.get(0).getClass())) return;
        try {
            beginTransaction();
