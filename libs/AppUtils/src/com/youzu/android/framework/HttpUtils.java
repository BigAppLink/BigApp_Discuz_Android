...
import com.youzu.android.framework.http.ResponseStream;
import com.youzu.android.framework.http.SyncHttpHandler;
...
import com.youzu.android.framework.http.client.DefaultSSLSocketFactory;
import com.youzu.android.framework.http.client.HttpRequest;
import com.youzu.android.framework.http.client.RetryHandler;
import com.youzu.android.framework.http.client.entity.GZipDecompressingEntity;
...
public class HttpUtils {
    ...
    public static HttpCache sHttpCache = new HttpCache();
    ...
    public HttpUtils configCacheMode(int cacheModel) {
        sHttpCache.setCacheMode(cacheModel);
        return this;
    }
    ...
    public String sendSync(HttpRequest.HttpMethod method, String url) throws HttpException {
        return sendSync(method, url, null);
    }

    public String sendSync(HttpRequest.HttpMethod method, String url, RequestParams params) throws HttpException {
        if (url == null) throw new IllegalArgumentException("url may not be null");
        LogUtils.e(url + params);
        HttpRequest request = new HttpRequest(method, url);
        ResponseStream responseStream = sendSyncRequest(request, params);
        if (responseStream != null) {
            try {
                return responseStream.readString(params);
            } catch (IOException e) {
                e.printStackTrace();
            } finally {
                try {
