...
import com.youzu.android.framework.json.JSONAware;
import com.youzu.android.framework.json.JSONException;
import com.youzu.android.framework.json.JSONObject;
import com.youzu.android.framework.json.JSONStreamAware;
import com.youzu.android.framework.json.TypeReference;
...
import com.youzu.android.framework.json.serializer.JSONSerializer;
import com.youzu.android.framework.json.serializer.SerializeConfig;
import com.youzu.android.framework.json.serializer.SerializeWriter;
...
import com.youzu.android.framework.json.util.IOUtils;
import com.youzu.android.framework.json.util.ThreadLocalCache;
import com.youzu.android.framework.json.util.TypeUtils;

/**
 * @author wenshao<szujobs@hotmail.com>
 */
public abstract class JsonUtils implements JSONStreamAware, JSONAware {
    ...
    static {
        int features = 0;
        features |= com.youzu.android.framework.json.serializer.SerializerFeature.QuoteFieldNames.getMask();
        features |= com.youzu.android.framework.json.serializer.SerializerFeature.SkipTransientField.getMask();
        features |= com.youzu.android.framework.json.serializer.SerializerFeature.WriteEnumUsingToString.getMask();
        features |= com.youzu.android.framework.json.serializer.SerializerFeature.SortField.getMask();
         features |= com.youzu.android.framework.json.serializer.SerializerFeature.WriteTabAsSpecial.getMask();
//        features |= com.alibaba.fastjson.serializer.SerializerFeature.WriteSlashAsSpecial.getMask();
    ...
    public static final JSONObject parseObject(String text) {
        ...
        return (JSONObject) JsonUtils.toJSON(obj);
    }
    ...
    public static final String toJSONString(Object object, SerializerFeature... features) {
        ...
        try {
            ...
            for (com.youzu.android.framework.json.serializer.SerializerFeature feature : features) {
    ...
    public static final Object toJSON(Object javaObject, ParserConfig mapping) {
        ...
        if (javaObject instanceof JsonUtils) {
            return (JsonUtils) javaObject;
        }
    ...
    public static final <T> T toJavaObject(JsonUtils jsonUtils, Class<T> clazz) {
        return TypeUtils.cast(jsonUtils, clazz, ParserConfig.getGlobalInstance());
    }
