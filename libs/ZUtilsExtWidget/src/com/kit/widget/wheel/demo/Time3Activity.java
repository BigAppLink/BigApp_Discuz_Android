...
public class Time3Activity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.wheel_time3_layout);
	...
	private class DayArrayAdapter extends AbstractWheelTextAdapter {
		...
		protected DayArrayAdapter(Context context, Calendar calendar) {
			super(context, R.layout.wheel_time3_day, NO_RESOURCE);
			this.calendar = calendar;

			setItemTextResource(R.id.time3_monthday);
		}
		...
		public View getItem(int index, View cachedView, ViewGroup parent) {
			...
			TextView weekday = (TextView) view.findViewById(R.id.time3_weekday);
			if (day == 0) {
				weekday.setText("");
			} else {
			...
			TextView monthday = (TextView) view
					.findViewById(R.id.time3_monthday);
			if (day == 0) {
