 ...
 *******************************************************************************/
package com.kit.pinnedsectionlistview;
...
public class PullToRefreshPinnedSectionListView extends PullToRefreshAdapterViewBase<ListView> {
    ...
    protected void handleStyledAttributes(TypedArray a) {
        ...
        if (mListViewExtrasEnabled) {
            ...
            ((PinnedSectionListView) getRefreshableView()).setLvFooterLoadingFrame(mLvFooterLoadingFrame);
    ...
    @TargetApi(9)
    final class InternalPinnedSectionListViewSDK9 extends PinnedSectionListView {
