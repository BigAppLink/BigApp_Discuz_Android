...
//        }
    ...
    public void init(int count, int position) {
...
//                playTo(position);
    ...
    public void setIndicatorCount(int count, int position) {
        Log.e("APP", "count:" + count + " mImageViews.size():" + mImageViews.size());
        init(count, position);
    ...
    public void playBy(int startPosition, int nextPosition) {
        ...
        anim1.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animation) {
                animPointTrans(imageViewStrat, imageViewNext);
            }
    ...
    private void animPointOut(ImageView imageViewStrat) {
        if (mPlayByOutAnimatorSet != null && mPlayByOutAnimatorSet.isRunning()) {
            mPlayByOutAnimatorSet.cancel();
            mPlayByOutAnimatorSet = null;
        }
        getAnimPointOut(imageViewStrat);
        mPlayByOutAnimatorSet.start();

    }

    private void animPointIn(ImageView imageViewNext) {
        if (mPlayByInAnimatorSet != null && mPlayByInAnimatorSet.isRunning()) {
            mPlayByInAnimatorSet.cancel();
            mPlayByInAnimatorSet = null;
        }
        mPlayByInAnimatorSet = getAnimPointIn(imageViewNext);
        mPlayByInAnimatorSet.start();
    }
