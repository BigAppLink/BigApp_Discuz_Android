...
public class BaseAdapterHelper {
    ...
    public BaseAdapterHelper setImageUrl(int viewId, String imageUrl) {
        ...
        if (iImageLoader == null) {
            Glide.with(context).load(imageUrl).asGif().into(view);
        } else
            iImageLoader.load(view, imageUrl);
        return this;
    }


    public BaseAdapterHelper setImageUrl(IImageLoader iImageLoader, int viewId, String imageUrl) {
